package com.example.prashant.materialdesign.ui.transitions;
...
public class LiftOff extends Transition {
    ...
    private static final String PROP_NAME_ELEVATION = "app:liftoff:elevation";
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        transitionValues.values.put(PROP_NAME_ELEVATION, initialElevation);
    }

    @Override
    public void captureEndValues(TransitionValues transitionValues) {
        transitionValues.values.put(PROP_NAME_ELEVATION, finalElevation);
    }
